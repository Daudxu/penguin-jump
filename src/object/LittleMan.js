...
class LittleMan {
  ...
  constructor (stage, boxGroup) {
    ...
    // 定义小人的材质，方便复用
    this.materail = new THREE.MeshLambertMaterial({color: LITTLE_MAN_COLOR});
    // 头部
    this.head = null;
    // 躯干
  ...
  initHead() {
    ...
    this.head = new THREE.Mesh(headGeometry, this.materail);
    // 小人也能投射阴影
